  ...
  return (
    <Card className={classes.card} raised elevation={6}>
      ...
      >
        ...
        <CardContent>
          <Typography variant="body2" style={{padding: '0 0 8px 15px', color: '#575859'}} component="p">{post.message?.length > 20 ? post?.message.substring(0, 15).concat('...') : post.message}</Typography>
        </CardContent>
      </ButtonBase>
